...
const Contacts = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: "Mail",
      title: "Email",
      primary: "info@medovaya-usadba.ru",
      secondary: "Ответим в течение дня",
    ...
    },
    {
      icon: "MapPin",
      title: "Адрес пасеки",
      primary: "Тульская область",
      secondary: "д. Медовка, ул. Пасечная 12",
      description: "Приезжайте к нам в гости"
    }
  ];
  ...
  const faq = [
    {
      ...
      answer: "Весь наш мед проходит лабораторные исследования. К каждой партии прилагается сертификат качества. Также вы можете запросить результаты анализов."
    },
    {
      question: "Можно ли посетить пасеку?",
      answer: "Да, мы проводим экскурсии по пасеке с мая по сентябрь. Предварительная запись обязательна. Звоните или пишите нам."
    },
    {
      question: "Есть ли скидки для постоянных клиентов?",
      answer: "Да, у нас действует программа лояльности. При заказе от 5000 рублей - скидка 5%, от 10000 рублей - 10%."
    },
    {
      question: "Как хранить мед?",
      answer: "Мед следует хранить в темном прохладном месте при температуре не выше 20°C. Избегайте попадания влаги и прямых солнечных лучей."
    }
  ];
